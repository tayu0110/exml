...
pub mod libxml_api {
    ...
    pub extern "C" fn xml_list_walk(
        ...
        let walker =
            move |data: &*mut c_void| -> bool { walker(*data as *const c_void, user) != 0 };
    ...
    pub extern "C" fn xml_list_merge(l1: XmlListPtr, l2: XmlListPtr) {
        let (Some(mut l1), Some(mut l2)) = (XmlListRef::from_raw(l1), XmlListRef::from_raw(l2))
        else {
            return;
        };
