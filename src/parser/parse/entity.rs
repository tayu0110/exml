...
use crate::{
    ...
    parser::{
        XmlParserCtxt, XmlParserInput, xml_create_entity_parser_ctxt_internal, xml_fatal_err,
        xml_fatal_err_msg, xml_fatal_err_msg_int, xml_free_parser_ctxt, xml_warning_msg,
    },
    tree::{
