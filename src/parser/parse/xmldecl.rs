...
impl XmlParserCtxt<'_> {
    ...
    fn parse_version_info(&mut self) -> Option<String> {
    ...
    fn parse_encoding_decl(&mut self) -> Option<String> {
        self.skip_blanks();
    ...
    pub(crate) fn parse_xmldecl(&mut self) {
