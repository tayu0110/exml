...
pub(crate) unsafe fn parse_comment(ctxt: &mut XmlParserCtxt) {
    ...
    let has_sax_comment = ctxt
        .sax
        .as_deref()
        .map_or(false, |sax| sax.comment.is_some());
...
mod tests {
    ...
    use crate::{
        ...
        parser::{xml_ctxt_read_memory, xml_new_sax_parser_ctxt, XmlParserCtxt},
    };
