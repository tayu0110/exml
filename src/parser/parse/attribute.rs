...
use crate::{
    ...
    parser::{
        XmlParserCtxt, XmlParserInputState, XmlParserOption, check_language_id, xml_err_memory,
        xml_fatal_err, xml_fatal_err_msg, xml_fatal_err_msg_str, xml_warning_msg,
    },
