...
use crate::{
    ...
    libxml::{
        ...
        tree::{
            xmlAddChild, xmlCopyNode, xmlNewText, xmlNewTextLen, xml_add_next_sibling, XmlDocPtr,
            XmlElementType, XmlNodePtr,
        },
        xmlerror::{xmlResetError, XmlErrorDomain, XmlErrorLevel, XmlParserErrors},
        xmlstring::{xml_str_equal, xml_strchr, xml_strdup, xml_strlen, xml_strncmp, XmlChar},
        xpath::{
            xml_xpath_cmp_nodes, xml_xpath_free_object, xml_xpath_new_context,
            xml_xpath_object_copy, XmlNodeSetPtr, XmlXPathContextPtr, XmlXPathError,
            XmlXPathObject, XmlXPathObjectPtr, XmlXPathObjectType, XmlXPathParserContextPtr,
        },
        xpath_internals::{
            value_pop, value_push, xml_xpath_err, xml_xpath_eval_expr,
            xml_xpath_evaluate_predicate_result, xml_xpath_free_parser_context,
            ...
            xml_xpath_register_func, xml_xpath_register_ns, xml_xpath_root,
        },
    },
    CHECK_ARITY, CHECK_ERROR, CHECK_TYPE, XP_ERROR,
};
