...
use crate::{
    ...
    parser::{
        ...
        XmlParserCharValid, XmlParserInputPtr, XmlParserNodeInfo, XmlParserNodeInfoSeq,
        __xml_err_encoding, xml_err_attribute_dup, xml_err_encoding_int, xml_err_memory,
        xml_fatal_err_msg_int, xml_ns_warn,
    },
    tree::{
...
use super::{
    ...
    parser_internals::{LINE_LEN, XML_MAX_LOOKUP_LIMIT, XML_PARSER_MAX_DEPTH, XML_VCTXT_USE_PCTXT},
...
pub struct XmlParserCtxt {
    ...
    // array of nodes
    pub(crate) name_tab: Vec<*const XmlChar>,
