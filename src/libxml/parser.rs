...
use crate::{
    ...
    libxml::{
        ...
        parser_internals::{
            ...
            xml_parse_reference, xml_parse_start_tag,
        },
    ...
    parser::{
        ...
        parse_char_data_internal, parse_comment, parse_entity_decl, parse_lookup_char,
        parse_lookup_char_data, parse_name, parse_notation_decl, parse_pi, parse_qname,
