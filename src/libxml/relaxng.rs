                ...
                for j in i + 1..nbgroups {
                    ...
                    if ret == 0 {
                        xml_rng_perr(
                            ...
                            Some("Element or text conflicts in interleave\n"),
                            null_mut(),
                            null_mut(),
                        );
                    }
                    ...
                    if ret == 0 {
                        xml_rng_perr(
                            ...
                            Some("Attributes conflicts in interleave\n"),
                            null_mut(),
                            null_mut(),
                        );
                    }
            ...
            if xml_str_equal((*cur).name, c"name".as_ptr() as _) {
                    ...
                    && !xml_str_equal((*node).name, c"define".as_ptr() as _)
                {
                    xml_rng_perr(
                        ...
                        Some("Attribute %s is not allowed on %s\n"),
                        (*cur).name,
                        (*node).name,
                    );
                }
                    ...
                    if !val.is_empty() {
                        ...
                        if uri.is_null() {
                            xml_rng_perr(
                                ...
                                Some("Attribute %s contains invalid URI %s\n"),
                                (*cur).name,
                            ...
                            if (*uri).scheme.is_null() {
                                xml_rng_perr(
                                    ...
                                    Some("Attribute %s URI %s is not absolute\n"),
                                    (*cur).name,
                                    val.as_ptr() as *const u8,
                                );
                            }
                            if !(*uri).fragment.is_null() {
                                xml_rng_perr(
                                    ...
                                    Some("Attribute %s URI %s has a fragment ID\n"),
                                    (*cur).name,
                                    val.as_ptr() as *const u8,
                                );
                            }
...
unsafe extern "C" fn xml_relaxng_load_external_ref(
    ...
    for i in 0..(*ctxt).doc_nr {
        if xml_str_equal((*(*(*ctxt).doc_tab.add(i as usize))).href, url) {
            xml_rng_perr(
                ...
                Some("Detected an externalRef recursion for %s\n"),
                url,
                null_mut(),
            );
            return null_mut();
    ...
    if doc.is_null() {
        xml_rng_perr(
            ...
            Some("xmlRelaxNG: could not load %s\n"),
            url,
            null_mut(),
        );
        return null_mut();
    ...
    if ret.is_null() {
        xml_rng_perr(
            ...
            doc as _,
            XmlParserErrors::XmlErrNoMemory,
            Some("xmlRelaxNG: allocate memory for doc %s\n"),
            url,
            null_mut(),
        );
        xml_free_doc(doc);
...
unsafe extern "C" fn xml_relaxng_load_include(
    ...
    for i in 0..(*ctxt).inc_nr {
        if xml_str_equal((*(*(*ctxt).inc_tab.add(i as usize))).href, url) {
            xml_rng_perr(
                ...
                Some("Detected an Include recursion for %s\n"),
                url,
                null_mut(),
            );
            return null_mut();
    ...
    if root.is_null() {
        xml_rng_perr(
            ...
            Some("xmlRelaxNG: included document is empty %s\n"),
            url,
            null_mut(),
        );
        return null_mut();
    ...
    if !IS_RELAXNG!(root, c"grammar".as_ptr() as _) {
        xml_rng_perr(
            ...
            Some("xmlRelaxNG: included document %s root is not a grammar\n"),
            url,
            null_mut(),
        );
        return null_mut();
        ...
        if IS_RELAXNG!(cur, c"start".as_ptr() as _) {
            ...
            if found == 0 {
                xml_rng_perr(
                    ...
                    Some("xmlRelaxNG: include %s has a start but not the included grammar\n"),
                    url,
                    null_mut(),
                );
            }
            ...
            if let Some(name) = (*cur).get_prop("name") {
                ...
                xml_rng_perr(
                    ...
                    Some("xmlRelaxNG: include %s has define without name\n"),
                    url,
                    null_mut(),
                );
            }
                    ...
                    || !xml_str_equal((*(*cur).ns).href, XML_RELAXNG_NS.as_ptr() as _)
                {
                    if let Some(parent) = (*cur).parent().filter(|p| {
                        ...
                        xml_rng_perr(
                            ...
                            Some("element %s doesn't allow foreign elements\n"),
                            parent.name,
                            null_mut(),
                        );
                    }
                    ...
                    if xml_str_equal((*cur).name, c"externalRef".as_ptr() as _) {
                        ...
                        let Some(href) = (*cur).get_prop("href") else {
                            xml_rng_perr(
                                ...
                                Some("xmlRelaxNGParse: externalRef has no href attribute\n"),
                                null_mut(),
                                null_mut(),
                            );
                            delete = cur;
                        ...
                        let Some(uri) = XmlURI::parse(&href) else {
                            ...
                            xml_rng_perr(
                                ...
                                Some("Incorrect URI for externalRef %s\n"),
                        ...
                        if uri.fragment.is_some() {
                            ...
                            xml_rng_perr(
                                ...
                                cur,
                                XmlParserErrors::XmlRngpHrefError,
                                Some("Fragment forbidden in URI for externalRef %s\n"),
                                href.as_ptr() as *const u8,
                                null_mut(),
                            );
                            delete = cur;
                        ...
                        let Some(url) = (*cur)
                            ...
                            xml_rng_perr(
                                ...
                                cur,
                                XmlParserErrors::XmlRngpHrefError,
                                Some("Failed to compute URL for externalRef %s\n"),
                                href.as_ptr() as *const u8,
                                null_mut(),
                            );
                            delete = cur;
                        ...
                        if docu.is_null() {
                            xml_rng_perr(
                                ...
                                Some("Failed to load externalRef %s\n"),
                                url.as_ptr() as *const u8,
                                null_mut(),
                            );
                            delete = cur;
                        ...
                        let Some(href) = (*cur).get_prop("href") else {
                            xml_rng_perr(
                                ...
                                cur,
                                XmlParserErrors::XmlRngpMissingHref,
                                Some("xmlRelaxNGParse: include has no href attribute\n"),
                                null_mut(),
                                null_mut(),
                            );
                            delete = cur;
                        ...
                        let Some(url) = (*cur)
                            ...
                            xml_rng_perr(
                                ...
                                cur,
                                XmlParserErrors::XmlRngpHrefError,
                                Some("Failed to compute URL for include %s\n"),
                                href.as_ptr() as *const u8,
                                null_mut(),
                            );
                            delete = cur;
                        ...
                        if let Some(name) = (*cur).get_prop("name") {
                            ...
                            if text.is_null() {
                                xml_rng_perr(
                                    ...
                                    Some("Failed to create a name %s element\n"),
                                    name.as_ptr() as *const u8,
                                    null_mut(),
                                );
                            }
                        ...
                        || xml_str_equal((*cur).name, c"value".as_ptr() as _)
                    {
                                ...
                                if let Some((prefix, local)) = split_qname2(&name) {
                                    ...
                                    if ns.is_null() {
                                        ...
                                        xml_rng_perr(
                                            ...
                                            Some("xmlRelaxNGParse: no namespace for prefix %s\n"),
                            ...
                            && (*ctxt).flags & XML_RELAXNG_IN_NSEXCEPT != 0
                        {
                            xml_rng_perr(
                                ...
                                Some("Found nsName/except//nsName forbidden construct\n"),
                                null_mut(),
                                null_mut(),
                            );
                        }
                        ...
                        if (*ctxt).flags & XML_RELAXNG_IN_ANYEXCEPT != 0 {
                            xml_rng_perr(
                                ...
                                Some("Found anyName/except//anyName forbidden construct\n"),
                                null_mut(),
                                null_mut(),
                            );
                            ...
                            xml_rng_perr(
                                ...
                                Some("Found nsName/except//anyName forbidden construct\n"),
                                null_mut(),
                                null_mut(),
                            );
                        }
...
unsafe extern "C" fn xml_relaxng_cleanup_doc(
    ...
    if root.is_null() {
        xml_rng_perr(
            ...
            doc as _,
            XmlParserErrors::XmlRngpEmpty,
            Some("xmlRelaxNGParse: %s is empty\n"),
            (*ctxt).url,
            null_mut(),
        );
        return null_mut();
        ...
        while !cur.is_null() {
            if let Some(combine) = (*(*cur).node).get_prop("combine") {
                if combine == "choice" {
                    if choice_or_interleave == -1 {
                        ...
                        xml_rng_perr(
                            ...
                            Some("Defines for %s use both 'choice' and 'interleave'\n"),
                            name,
                            null_mut(),
                        );
                    }
                    ...
                    xml_rng_perr(
                        ...
                        Some("Defines for %s use unknown combine value '%s''\n"),
                        name,
                ...
                xml_rng_perr(
                    ...
                    Some("Some defines for %s needs the combine attribute\n"),
                    name,
                    null_mut(),
                );
            }
            ...
            if let Some(mut table) = (*ctxt).interleaves {
                    ...
                    .is_err()
                {
                    xml_rng_perr(
                        ...
                        Some("Failed to add %s to hash table\n"),
                        tmpname.as_ptr() as _,
                        null_mut(),
                    );
                }
                ...
                xml_rng_perr(
                    ...
                    (*define).node,
                    XmlParserErrors::XmlRngpInterleaveCreateFailed,
                    Some("Failed to create interleaves hash table\n"),
                    null_mut(),
                    null_mut(),
                );
            }
    ...
    unsafe {
        ...
        if grammar.is_null() {
            xml_rng_perr(
                ...
                Some("Internal error: no grammar in CheckReference %s\n"),
                name,
                null_mut(),
            );
            return;
        ...
        if !(*refe).content.is_null() {
            xml_rng_perr(
                ...
                (*refe).node,
                XmlParserErrors::XmlErrInternalError,
                Some("Internal error: reference has content in CheckReference %s\n"),
                name,
                null_mut(),
            );
            return;
        ...
        if let Some(defs) = (*grammar).defs {
            ...
            if !def.is_null() {
                ...
                xml_rng_perr(
                    ...
                    Some("Reference %s has no matching definition\n"),
                    name,
                    null_mut(),
                );
            }
...
unsafe extern "C" fn xml_relaxng_parse_except_name_class(
    ...
    if (*node).next.is_some() {
        xml_rng_perr(
            ...
            Some("exceptNameClass allows only a single except node\n"),
            null_mut(),
            null_mut(),
        );
    }
    ...
    if IS_RELAXNG!(node, c"name".as_ptr() as _) {
        ...
        if xml_validate_ncname(val, 0) != 0 {
            if let Some(parent) = (*node).parent() {
                xml_rng_perr(
                    ...
                    Some("Element %s name '%s' is not an NCName\n"),
                    parent.name,
                    val,
                );
            } else {
            ...
            && xml_str_equal(val, c"http://www.w3.org/2000/xmlns".as_ptr() as _)
        {
            xml_rng_perr(
                ...
                Some("Attribute with namespace '%s' is not allowed\n"),
                val,
                null_mut(),
            );
        }
            ...
            && xml_str_equal((*ret).name, c"xmlns".as_ptr() as _)
        {
            xml_rng_perr(
                ...
                Some("Attribute with QName 'xmlns' is not allowed\n"),
                val,
                null_mut(),
            );
        }
        ...
        if (*ret).ns.is_null() {
            xml_rng_perr(
                ...
                Some("nsName has no ns attribute\n"),
                null_mut(),
                null_mut(),
            );
        }
        ...
        xml_rng_perr(
            ...
            Some("expecting name, anyName, nsName or choice : got %s\n"),
            if node.is_null() {
...
unsafe extern "C" fn xml_relaxng_parse_data(
    ...
    if xml_validate_ncname(typ, 0) != 0 {
        xml_rng_perr(
            ...
            Some("data type '%s' is not an NCName\n"),
            typ,
            null_mut(),
        );
    }
    ...
    if lib.is_null() {
        xml_rng_perr(
            ...
            Some("Use of unregistered type library '%s'\n"),
            library,
            null_mut(),
        );
        (*def).data = null_mut();
        ...
        if let Some(have) = (*lib).have {
            ...
            if tmp != 1 {
                xml_rng_perr(
                    ...
                    Some("Error type '%s' is not exported by type library '%s'\n"),
                    (*def).name,
                    library,
                );
            ...
            xml_rng_perr(
                ...
                Some("Internal error with type library '%s': no 'have'\n"),
                library,
                null_mut(),
            );
        }
    ...
    while !content.is_null() {
        ...
        if xml_str_equal(
            ...
            xml_rng_perr(
                ...
                Some("Type library '%s' does not allow type parameters\n"),
                library,
                null_mut(),
            );
    ...
    if !content.is_null() {
        xml_rng_perr(
            ...
            Some("Element data has unexpected content %s\n"),
            (*content).name,
            null_mut(),
        );
    }
...
unsafe extern "C" fn xml_relaxng_parse_attribute(
    ...
    if child.is_null() {
        xml_rng_perr(
            ...
            Some("xmlRelaxNGParseattribute: attribute has no children\n"),
            null_mut(),
            null_mut(),
        );
        return ret;
            ...
            match (*cur).typ {
                ...
                XmlRelaxNGType::Start | XmlRelaxNGType::Param | XmlRelaxNGType::Except => {
                    xml_rng_perr(
                        ...
                        Some("attribute has invalid content\n"),
                        null_mut(),
                        null_mut(),
                    );
                }
                XmlRelaxNGType::Noop => {
                    xml_rng_perr(
                        ...
                        Some("RNG Internal error, noop found in attribute\n"),
                        null_mut(),
                        null_mut(),
                    );
                }
    ...
    if !child.is_null() {
        xml_rng_perr(
            ...
            Some("attribute has multiple children\n"),
            null_mut(),
            null_mut(),
        );
    }
...
unsafe extern "C" fn xml_relaxng_parse_value(
    ...
    if let Some(typ) = (*node).get_prop("type") {
        ...
        if xml_validate_ncname(typ, 0) != 0 {
            xml_rng_perr(
                ...
                node,
                XmlParserErrors::XmlRngpTypeValue,
                Some("value typ '%s' is not an NCName\n"),
                typ,
                null_mut(),
            );
        }
        ...
        .is_some()
    {
        xml_rng_perr(
            ...
            Some("Expecting a single text value for <value>content\n"),
            null_mut(),
            null_mut(),
        );
        ...
        if (*def).value.is_null() {
            xml_rng_perr(
                ...
                Some("Element <value> has no content\n"),
                null_mut(),
                null_mut(),
            );
            ...
            if success != 1 {
                xml_rng_perr(
                    ...
                    Some("Value '%s' is not acceptable for type '%s'\n"),
                    (*def).value,
                    (*def).name,
                );
            } else if !val.is_null() {
...
unsafe extern "C" fn xml_relaxng_parse_interleave(
    ...
    if child.is_null() {
        xml_rng_perr(
            ...
            Some("Element interleave is empty\n"),
            null_mut(),
            null_mut(),
        );
    }
...
unsafe extern "C" fn xml_relaxng_parse_import_refs(
    ...
    let Some(refs) = (*(*ctxt).grammar).refs else {
        xml_rng_perr(
            ...
            null_mut(),
            XmlParserErrors::XmlRngpRefCreateFailed,
            Some("Could not create references hash\n"),
            null_mut(),
            null_mut(),
        );
        return -1;
    ...
    if IS_RELAXNG!(node, c"element".as_ptr() as _) {
        ...
        if (*def).name.is_null() {
            ...
            if xml_validate_ncname((*def).name, 0) != 0 {
                xml_rng_perr(
                    ...
                    Some("ref name '%s' is not an NCName\n"),
                    (*def).name,
                    null_mut(),
                );
            }
        ...
        if (*node).children().is_some() {
            xml_rng_perr(
                ...
                Some("xmlRelaxNGParse: notAllowed element is not empty\n"),
                null_mut(),
                null_mut(),
            );
        }
        ...
        if (*ctxt).parentgrammar.is_null() {
            xml_rng_perr(
                ...
                Some("Use of parentRef without a parent grammar\n"),
                null_mut(),
                null_mut(),
            );
            return null_mut();
        ...
        if (*def).name.is_null() {
            ...
            if xml_validate_ncname((*def).name, 0) != 0 {
                xml_rng_perr(
                    ...
                    Some("parentRef name '%s' is not an NCName\n"),
                    (*def).name,
                    null_mut(),
                );
            }
                    ...
                    .is_err()
            {
                ...
                if prev.is_null() {
                    xml_rng_perr(
                        ...
                        Some("Internal error parentRef definitions '%s'\n"),
                        (*def).name,
                        null_mut(),
                    );
                    def = null_mut();
        ...
        xml_rng_perr(
            ...
            Some("Unexpected node %s is not a pattern\n"),
            (*node).name,
            null_mut(),
        );
        def = null_mut();
...
unsafe extern "C" fn xml_relaxng_parse_element(
    ...
    let Some(mut child) = (*node).children().map(|c| c.as_ptr()) else {
        xml_rng_perr(
            ...
            Some("xmlRelaxNGParseElement: element has no children\n"),
            null_mut(),
            null_mut(),
        );
        return ret;
    ...
    if child.is_null() {
        xml_rng_perr(
            ...
            Some("xmlRelaxNGParseElement: element has no content\n"),
            null_mut(),
            null_mut(),
        );
        return ret;
            ...
            match (*cur).typ {
                ...
                XmlRelaxNGType::Start => {
                    xml_rng_perr(
                        ...
                        Some("RNG Internal error, start found in element\n"),
                        null_mut(),
                        null_mut(),
                    );
                }
                XmlRelaxNGType::Param => {
                    xml_rng_perr(
                        ...
                        node,
                        XmlParserErrors::XmlRngpElementContent,
                        Some("RNG Internal error, param found in element\n"),
                        null_mut(),
                        null_mut(),
                    );
                }
                XmlRelaxNGType::Except => {
                    xml_rng_perr(
                        ...
                        node,
                        XmlParserErrors::XmlRngpElementContent,
                        Some("RNG Internal error, except found in element\n"),
                        null_mut(),
                        null_mut(),
                    );
                }
                XmlRelaxNGType::Noop => {
                    xml_rng_perr(
                        ...
                        node,
                        XmlParserErrors::XmlRngpElementContent,
                        Some("RNG Internal error, noop found in element\n"),
                        null_mut(),
                        null_mut(),
                    );
                }
...
unsafe extern "C" fn xml_relaxng_parse_start(
    ...
    if IS_RELAXNG!(nodes, c"empty".as_ptr() as _) {
        ...
        if (*nodes).children().is_some() {
            xml_rng_perr(
                ...
                Some("element empty is not empty\n"),
                null_mut(),
                null_mut(),
            );
        }
        ...
        if (*nodes).children().is_some() {
            xml_rng_perr(
                ...
                nodes,
                XmlParserErrors::XmlRngpNotAllowedNotEmpty,
                Some("element notAllowed is not empty\n"),
                null_mut(),
                null_mut(),
            );
        }
    ...
    if !nodes.is_null() {
        xml_rng_perr(
            ...
            Some("start more than one children\n"),
            null_mut(),
            null_mut(),
        );
        return -1;
    ...
    if let Some(name) = (*node).get_prop("name") {
        ...
        if xml_validate_ncname(name, 0) != 0 {
            xml_rng_perr(
                ...
                Some("define name '%s' is not an NCName\n"),
                name,
                null_mut(),
            );
        }
        ...
        if let Some(mut defs) = (*(*ctxt).grammar).defs {
                ...
                .is_err()
            {
                ...
                if prev.is_null() {
                    xml_rng_perr(
                        ...
                        Some("Internal error on define aggregation of %s\n"),
                        name,
                        null_mut(),
                    );
                    ret = -1;
            ...
            xml_rng_perr(
                ...
                node,
                XmlParserErrors::XmlRngpDefineCreateFailed,
                Some("Could not create definition hash\n"),
                null_mut(),
                null_mut(),
            );
            ret = -1;
...
unsafe extern "C" fn xml_relaxng_parse_include(
    ...
    if root.is_null() {
        xml_rng_perr(
            ...
            node,
            XmlParserErrors::XmlRngpEmpty,
            Some("Include document is empty\n"),
            null_mut(),
            null_mut(),
        );
        return -1;
    ...
    if !xml_str_equal((*root).name, c"grammar".as_ptr() as _) {
        xml_rng_perr(
            ...
            node,
            XmlParserErrors::XmlRngpGrammarMissing,
            Some("Include document root is not a grammar\n"),
            null_mut(),
            null_mut(),
        );
        return -1;
    ...
    while !nodes.is_null() {
        if IS_RELAXNG!(nodes, c"start".as_ptr() as _) {
            ...
            xml_rng_perr(
                ...
                Some("grammar has unexpected child %s\n"),
                (*nodes).name,
                null_mut(),
            );
            ret = -1;
    ...
    while !cur.is_null() {
        let combine = if (*cur).node.is_null()
            ...
            xml_rng_perr(
                ...
                (*cur).node,
                XmlParserErrors::XmlRngpStartMissing,
                Some("Internal error: start element not found\n"),
                null_mut(),
                null_mut(),
            );
            None
        ...
        if let Some(combine) = combine {
            if combine == "choice" {
                if choice_or_interleave == -1 {
                    ...
                    xml_rng_perr(
                        ...
                        Some("<start> use both 'choice' and 'interleave'\n"),
                        null_mut(),
                        null_mut(),
                    );
                }
                ...
                xml_rng_perr(
                    ...
                    (*cur).node,
                    XmlParserErrors::XmlRngpUnknownCombine,
                    Some("<start> uses unknown combine value '%s''\n"),
                    combine.as_ptr() as *const u8,
                    null_mut(),
                );
            }
            ...
            xml_rng_perr(
                ...
                (*cur).node,
                XmlParserErrors::XmlRngpNeedCombine,
                Some("Some <start> element miss the combine attribute\n"),
                null_mut(),
                null_mut(),
            );
        }
...
unsafe extern "C" fn xml_relaxng_parse_grammar(
    ...
    if (*ctxt).grammar.is_null() {
        xml_rng_perr(
            ...
            nodes,
            XmlParserErrors::XmlRngpGrammarContent,
            Some("Failed to parse <grammar> content\n"),
            null_mut(),
            null_mut(),
        );
        ...
        xml_rng_perr(
            ...
            Some("Element <grammar> has no <start>\n"),
            null_mut(),
            null_mut(),
        );
    }
        ...
        if matches!((*cur).typ, XmlRelaxNGType::Ref | XmlRelaxNGType::Parentref) {
            if (*cur).depth == -1 {
                ...
                xml_rng_perr(
                    ...
                    Some("Detected a cycle in %s references\n"),
                    (*cur).name,
                    null_mut(),
                );
                return -1;
        ...
        for j in 0..i {
            ...
            if ret == 0 {
                xml_rng_perr(
                    ...
                    Some("Attributes conflicts in group\n"),
                    null_mut(),
                    null_mut(),
                );
            }
        ...
        if matches!((*cur).typ, XmlRelaxNGType::Ref | XmlRelaxNGType::Parentref) {
            ...
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//ref\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if (*cur).content.is_null() {
                if (*cur).typ == XmlRelaxNGType::Parentref {
                    xml_rng_perr(
                        ...
                        (*cur).node,
                        XmlParserErrors::XmlRngpRefNoDef,
                        Some("Internal found no define for parent refs\n"),
                        null_mut(),
                        null_mut(),
                    );
                } else {
                    xml_rng_perr(
                        ...
                        (*cur).node,
                        XmlParserErrors::XmlRngpRefNoDef,
                        Some("Internal found no define for ref %s\n"),
                        if !(*cur).name.is_null() {
                            (*cur).name
                        } else {
                            c"null".as_ptr() as _
            ...
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//element(ref)\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_LIST != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern list//element(ref)\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_ATTRIBUTE != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern attribute//element(ref)\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            ...
            if ret != XmlRelaxNGContentType::Empty {
                xml_rng_perr(
                    ...
                    Some("Element %s attributes have a content type error\n"),
                    (*cur).name,
                    null_mut(),
                );
            }
            ...
            if ret == XmlRelaxNGContentType::Error {
                xml_rng_perr(
                    ...
                    Some("Element %s has a content type error\n"),
                    (*cur).name,
                    null_mut(),
                );
            } else {
            ...
            if flags & XML_RELAXNG_IN_ATTRIBUTE != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern attribute//attribute\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_LIST != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern list//attribute\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_OOMGROUP != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern oneOrMore//group//attribute\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_OOMINTERLEAVE != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern oneOrMore//interleave//attribute\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//attribute\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern start//attribute\n"),
                    null_mut(),
                    null_mut(),
                );
            }
                ...
                && (*cur).name_class.is_null()
            {
                if (*cur).ns.is_null() {
                    xml_rng_perr(
                        ...
                        Some("Found anyName attribute without oneOrMore ancestor\n"),
                        null_mut(),
                        null_mut(),
                    );
                } else {
                    xml_rng_perr(
                        ...
                        Some("Found nsName attribute without oneOrMore ancestor\n"),
                        null_mut(),
                        null_mut(),
                    );
                }
            ...
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//oneOrMore\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern start//oneOrMore\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            ...
            if flags & XML_RELAXNG_IN_LIST != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern list//list\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//list\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern start//list\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            ...
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//group\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern start//group\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            ...
            if flags & XML_RELAXNG_IN_LIST != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern list//interleave\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//interleave\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    (*cur).node,
                    XmlParserErrors::XmlRngpPatDataExceptInterleave,
                    Some("Found forbidden pattern start//interleave\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            ...
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern start//data\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            ...
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern start//value\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            ...
            if flags & XML_RELAXNG_IN_LIST != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern list//text\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//text\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern start//text\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            ...
            if flags & XML_RELAXNG_IN_DATAEXCEPT != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern data/except//empty\n"),
                    null_mut(),
                    null_mut(),
                );
            }
            if flags & XML_RELAXNG_IN_START != 0 {
                xml_rng_perr(
                    ...
                    Some("Found forbidden pattern start//empty\n"),
                    null_mut(),
                    null_mut(),
                );
            }
    ...
    if !(*ctxt).url.is_null() {
        ...
        if doc.is_null() {
            xml_rng_perr(
                ...
                null_mut(),
                XmlParserErrors::XmlRngpParseError,
                Some("xmlRelaxNGParse: could not load %s\n"),
                (*ctxt).url,
                null_mut(),
            );
            return null_mut();
        ...
        if doc.is_null() {
            xml_rng_perr(
                ...
                null_mut(),
                XmlParserErrors::XmlRngpParseError,
                Some("xmlRelaxNGParse: could not parse schemas\n"),
                null_mut(),
                null_mut(),
            );
            return null_mut();
        ...
        xml_rng_perr(
            ...
            null_mut(),
            XmlParserErrors::XmlRngpEmpty,
            Some("xmlRelaxNGParse: nothing to parse\n"),
            null_mut(),
            null_mut(),
        );
        return null_mut();
