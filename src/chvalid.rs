...
pub(crate) fn xml_char_in_range(val: u32, rptr: &XmlChRangeGroup) -> bool {
...
pub(crate) trait XmlCharValid {
    fn is_xml_char(&self) -> bool;
    fn is_xml_base_char(&self) -> bool;
    fn is_xml_blank_char(&self) -> bool;
    fn is_xml_pubid_char(&self) -> bool;
    fn is_xml_combining(&self) -> bool;
    fn is_xml_digit(&self) -> bool;
    fn is_xml_extender(&self) -> bool;
    fn is_xml_ideographic(&self) -> bool;
}

impl XmlCharValid for u8 {
    #[doc(alias = "xmlIsCharCh")]
    fn is_xml_char(&self) -> bool {
        (0x9..=0xa).contains(self) || *self == 0xd || 0x20 <= *self
    }

    #[doc(alias = "XmlIsBaseCharCh")]
    fn is_xml_base_char(&self) -> bool {
        (0x41..=0x5a).contains(self)
            || (0x61..=0x7a).contains(self)
            || (0xc0..=0xd6).contains(self)
            || (0xd8..=0xf6).contains(self)
            || 0xf8 <= *self
    }

    #[doc(alias = "XmlIsBlankCh")]
    fn is_xml_blank_char(&self) -> bool {
        *self == 0x20 || (0x9..=0xa).contains(self) || *self == 0xd
    }

    #[doc(alias = "xmlIsPubidChar_ch")]
    fn is_xml_pubid_char(&self) -> bool {
        XML_IS_PUBID_CHAR_TAB[*self as usize]
    }
    ...
    #[doc(alias = "xmlIsDigit_ch")]
    fn is_xml_digit(&self) -> bool {
        self.is_ascii_digit()
    }

    #[doc(alias = "xmlIsExtender_ch")]
    fn is_xml_extender(&self) -> bool {
        *self == 0xb7
    }
...
impl XmlCharValid for u32 {
    #[doc(alias = "xmlIsCharQ")]
    fn is_xml_char(&self) -> bool {
        if *self < 0x100 {
            (*self as u8).is_xml_char()
        } else {
            (0x100..=0xd7ff).contains(self)
                || (0xe000..=0xfffd).contains(self)
                || (0x10000..=0x10ffff).contains(self)
        }
    }
    ...
    fn is_xml_base_char(&self) -> bool {
        if *self < 0x100 {
            (*self as u8).is_xml_base_char()
        } else {
            xml_char_in_range(*self, &XML_IS_BASE_CHAR_GROUP)
        }
    }

    #[doc(alias = "xmlIsBlankQ")]
    fn is_xml_blank_char(&self) -> bool {
        *self < 0x100 && (*self as u8).is_xml_blank_char()
    }

    #[doc = "xmlIsPubidCharQ"]
    fn is_xml_pubid_char(&self) -> bool {
        *self < 0x100 && (*self as u8).is_xml_pubid_char()
    }
    ...
    fn is_xml_combining(&self) -> bool {
        if *self < 0x100 {
            ...
            xml_char_in_range(*self, &XML_IS_COMBINING_GROUP)
        }
    }

    #[doc(alias = "xmlIsDigitQ")]
    fn is_xml_digit(&self) -> bool {
        if *self < 0x100 {
            (*self as u8).is_xml_digit()
        } else {
            xml_char_in_range(*self, &XML_IS_DIGIT_GROUP)
        }
    }

    #[doc(alias = "xmlIsExtenderQ")]
    fn is_xml_extender(&self) -> bool {
        if *self < 0x100 {
            (*self as u8).is_xml_extender()
        } else {
            xml_char_in_range(*self, &XML_IS_EXTENDER_GROUP)
        }
    }

    #[doc(alias = "xmlIsIdeographicQ")]
    fn is_xml_ideographic(&self) -> bool {
        if *self < 0x100 {
            false
        } else {
            (0x4e00..=0x9fa5).contains(self) || *self == 0x3007 || (0x3021..=0x3029).contains(self)
        }
    }
}

impl XmlCharValid for char {
    fn is_xml_char(&self) -> bool {
        (*self as u32).is_xml_char()
    }
    fn is_xml_base_char(&self) -> bool {
        (*self as u32).is_xml_base_char()
    }
    fn is_xml_blank_char(&self) -> bool {
        (*self as u32).is_xml_blank_char()
    }
    fn is_xml_pubid_char(&self) -> bool {
        (*self as u32).is_xml_pubid_char()
    }
    fn is_xml_combining(&self) -> bool {
        (*self as u32).is_xml_combining()
    }
    fn is_xml_digit(&self) -> bool {
        (*self as u32).is_xml_digit()
    }
    fn is_xml_extender(&self) -> bool {
        (*self as u32).is_xml_extender()
    }
    fn is_xml_ideographic(&self) -> bool {
        (*self as u32).is_xml_ideographic()
    }
}
